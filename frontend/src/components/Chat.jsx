...
import { fetchChannels } from '../slices/channelsSliceEA.js'
import { selectors } from '../slices/channelsSliceEA.js'
...
const Chat = () => {
  ...
  // const channels = useSelector((state) => state.channelsEA)
  const channels = useSelector(selectors.selectEntities)
  console.log('chanels is: ', channels)
  // const activeChannelId = channels.activeChannel.id
  const activeChannel = useSelector(state => state.channelsEA.activeChannel)
  console.log('activeChannel is: ', activeChannel)

  const messages = useSelector(state => state.messages)
  const currentChannelMessages = messages.filter(m => m.channelId === activeChannel.id)
  ...
  const formik = useFormik({
    ...
    onSubmit: async (body) => {
      ...
      const payload = { token, username, body: body.message, channelId: activeChannel.id }
